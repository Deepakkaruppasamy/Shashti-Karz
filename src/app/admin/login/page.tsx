...
import { Eye, EyeOff, Lock, Shield, Zap, ArrowRight, Loader2, Sparkles } from "lucide-react";
        ...
        <div className="min-h-screen bg-[#020202] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden selection:bg-[#ff1744]/50">
            ...
            >
                <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#ff1744] to-[#f50057] mb-6 shadow-2xl shadow-[#ff1744]/30 relative overflow-hidden">
                        <Shield className="w-8 h-8 text-white relative z-10" />
                        <motion.div animate={{ x: ["-100%", "200%"] }} transition={{ duration: 2, repeat: Infinity, ease: "linear" }} className="absolute inset-0 bg-white/20 -skew-x-12" />
                    </div>
