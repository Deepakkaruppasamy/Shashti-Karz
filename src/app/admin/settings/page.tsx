              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between p-4 bg-white/5 rounded-xl">
                  ...
                  <button
                    ...
                    className={`relative w-14 h-7 rounded-full transition-colors ${
                      settings.visualEffectsEnabled ? "bg-[#d4af37]" : "bg-white/10"
                    }`}
                  >
                    <div className={`absolute top-1 w-5 h-5 rounded-full bg-white transition-transform ${
                      settings.visualEffectsEnabled ? "left-8" : "left-1"
                    }`} />
                  </button>
                </div>
              </div>
                  ...
                  <div key={item.key} className="flex items-center justify-between p-4 bg-white/5 rounded-xl">
                    ...
                    <button
                      ...
                      className={`relative w-12 h-6 rounded-full transition-colors ${
                        settings[item.key as keyof SoundSettings] ? "bg-green-500" : "bg-white/10"
                      }`}
                    >
                      <div className={`absolute top-1 w-4 h-4 rounded-full bg-white transition-transform ${
                        settings[item.key as keyof SoundSettings] ? "left-7" : "left-1"
                      }`} />
                    </button>
                  </div>
                ))}
