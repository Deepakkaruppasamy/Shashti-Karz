        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {packages.map((pkg, index) => (
            <motion.div
              ...
              className={`relative glass-card rounded-2xl p-6 cursor-pointer transition-all duration-300 ${selectedPackage === pkg.tier
                  ? "ring-2 scale-105"
            ...
            >
              ...
              <Link
                ...
                className={`w-full py-4 rounded-xl font-semibold flex items-center justify-center gap-2 transition-all ${pkg.popular
                    ? "btn-premium"
                    : pkg.tier === "ultimate"
                      ? "btn-gold"
