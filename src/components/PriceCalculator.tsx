                ...
                {addons.map((addon) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() => toggleAddon(addon.id)}
                        className={`w-6 h-6 rounded-full flex items-center justify-center transition-colors ${selectedAddons.includes(addon.id) ? "bg-[#d4af37]" : "bg-white/10"
                          }`}
                      >
                ...
                {packages.map((pkg) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={() => togglePackage(pkg.id)}
                        className={`w-6 h-6 rounded-full flex items-center justify-center transition-colors ${selectedPackages.includes(pkg.id) ? "bg-[#ff1744]" : "bg-white/10"
                          }`}
                      >
