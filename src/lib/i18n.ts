...
export const translations = {
  en: {
    ...
    hero_title_3: "Meets",
    hero_title_4: "Luxury",
    hero_subtitle: "Experience the finest car detailing service in Tamil Nadu. We treat every vehicle like a masterpiece.",
    ...
    premium_products_desc: "We use only world-class detailing products from brands like Gtechniq, Gyeon, and CarPro.",
    certified_experts: "Certified Experts",
    certified_experts_desc: "Our team is professionally trained and certified in advanced detailing techniques.",
    ai_powered_care: "AI-Powered Care",
    ai_powered_care_desc: "Smart recommendations based on your car type and usage patterns for optimal results.",
  ...
  hi: {
    ...
    hero_title_3: "मिलती है",
    hero_title_4: "विलासिता से",
    hero_subtitle: "तमिलनाडु में सबसे बेहतरीन कार डिटेलिंग सेवा का अनुभव करें। हम हर वाहन को एक कृति की तरह मानते हैं।",
    book_your_service: "अपनी सेवा बुक करें",
    ...
    premium_products_desc: "हम Gtechniq, Gyeon और CarPro जैसे ब्रांडों के विश्व-स्तरीय डिटेलिंग उत्पादों का उपयोग करते हैं।",
    certified_experts: "प्रमाणित विशेषज्ञ",
    certified_experts_desc: "हमारी टीम उन्नत डिटेलिंग तकनीकों में पेशेवर रूप से प्रशिक्षित और प्रमाणित है।",
    ai_powered_care: "AI-संचालित देखभाल",
    ai_powered_care_desc: "आपकी कार के प्रकार और उपयोग पैटर्न के आधार पर स्मार्ट सिफारिशें।",
    ...
    raise_request: "सेवा अनुरोध उठाएं",
  ...
  ta: {
    ...
    hero_title_3: "சந்திக்கிறது",
    hero_title_4: "ஆடம்பரத்தை",
    hero_subtitle: "தமிழ்நாட்டின் சிறந்த கார் டிடெய்லிங் சேவையை அனுபவியுங்கள். ஒவ்வொரு வாகனத்தையும் ஒரு கலைப்படைப்பாக நாங்கள் கருதுகிறோம்.",
    book_your_service: "உங்கள் சேவையை பதிவு செய்யுங்கள்",
    ...
    premium_products: "பிரீமியம் தயாரிப்புகள்",
    premium_products_desc: "Gtechniq, Gyeon மற்றும் CarPro போன்ற பிராண்டுகளின் உலகத் தரம் வாய்ந்த தயாரிப்புகளை மட்டுமே பயன்படுத்துகிறோம்.",
    certified_experts: "சான்றளிக்கப்பட்ட நிபுணர்கள்",
    certified_experts_desc: "எங்கள் குழு மேம்பட்ட டிடெய்லிங் நுட்பங்களில் தொழில்முறையில் பயிற்சி பெற்றது.",
    ai_powered_care: "AI இயங்கும் பராமரிப்பு",
    ai_powered_care_desc: "உங்கள் கார் வகை மற்றும் பயன்பாட்டு முறைகளின் அடிப்படையில் ஸ்மார்ட் பரிந்துரைகள்.",
    ...
    raise_request: "சேவை கோரிக்கையை எழுப்பவும்",
